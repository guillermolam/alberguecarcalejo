...
// Auth0 login handler
function handleLogin(req: Request, res: ResponseBuilder) {
...
async function handleCallback(req: Request, res: ResponseBuilder) {
  const config = getAuth0Config();
  const url = new URL(req.url);
...
function handleLogout(req: Request, res: ResponseBuilder) {
  const config = getAuth0Config();
  const url = new URL(req.url);
...
async function requireAuth0(req: Request, res: ResponseBuilder): Promise<boolean> {
