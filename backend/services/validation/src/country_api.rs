...
impl CountryService {
    pub fn new() -> Self {
        ...
        country_data.insert("spain".to_string(), CountryInfoResponse {
        ...
        country_data.insert("france".to_string(), CountryInfoResponse {
        ...
        country_data.insert("germany".to_string(), CountryInfoResponse {
        ...
        country_data.insert("italy".to_string(), CountryInfoResponse {
        ...
        country_data.insert("portugal".to_string(), CountryInfoResponse {
        ...
        country_data.insert("united kingdom".to_string(), CountryInfoResponse {
        ...
        country_data.insert("united states".to_string(), CountryInfoResponse {
    ...
    pub async fn get_country_info(&self, mut req: Request, rate_limiter: &RateLimiter) -> Result<Response> {
