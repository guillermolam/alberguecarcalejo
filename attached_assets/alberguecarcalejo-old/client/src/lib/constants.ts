export const LANGUAGES = [
  ...
  { code: 'eu', name: 'Euskera', flag: 'https://cdn-icons-png.flaticon.com/24/330/330592.png', flagAlt: 'EU' },
  { code: 'ca', name: 'Català', flag: 'https://flagcdn.com/16x12/ad.png', flagAlt: 'CA' },
  { code: 'val', name: 'Valencià', flag: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Flag_of_the_Valencian_Community_%282x3%29.svg/24px-Flag_of_the_Valencian_Community_%282x3%29.svg.png', flagAlt: 'VAL' },
  { code: 'gl', name: 'Galego', flag: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Flag_of_Galicia.svg/24px-Flag_of_Galicia.svg.png', flagAlt: 'GL' },
  { code: 'zh', name: '简体中文', flag: 'https://flagcdn.com/16x12/cn.png', flagAlt: 'CN' },
